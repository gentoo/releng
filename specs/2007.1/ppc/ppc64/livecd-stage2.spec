...
rel_type: default
profile: default-linux/ppc/ppc64/2007.0/32bit-userland/desktop
snapshot: 2007.0
source_subpath: default/livecd-stage1-ppc64-installer-32ul-2007.0

livecd/fstype: squashfs
livecd/cdtar: /usr/lib/catalyst/livecd/cdtar/yaboot-1.3.13-cdtar.tar.bz2
livecd/iso: /var/tmp/catalyst/builds/default/livecd-ppc64-installer-32ul-2007.0.iso
...
livecd/gk_mainargs: --kernel-cross-compile=powerpc64-unknown-linux-gnu- --utils-arch=ppc --arch-override=ppc --makeopts=-j8 --lvm2 --dmraid --evms2 --unionfs-dev
...
boot/kernel/ibm/config: /root/livecd/kconfig/releases/2007.0/ppc/ppc64/livecd-2.6.20-ibm.config
boot/kernel/ibm/console: ttyS0,9600 hvc0 hvsi0
boot/kernel/ibm/machine_type: ibm
boot/kernel/ibm/extraversion: ibm

boot/kernel/ppc32/config: /root/livecd/kconfig/releases/2007.0/ppc/ppc32/livecd-2.6.20-ppc32.config
...
boot/kernel/ppc64/config: /root/livecd/kconfig/releases/2007.0/ppc/ppc64/livecd-2.6.20-ppc64.config
boot/kernel/ppc64/console: ttyS0,57600
boot/kernel/ppc64/extraversion: ppc64

boot/kernel/pegasos/config: /root/livecd/kconfig/releases/2007.0/ppc/ppc32/installcd-2.6.20-pegasos.config
